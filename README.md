...
[![Google Cloud](https://img.shields.io/badge/Google%20Cloud%20Ready%20Facilitator-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white)](https://cloud.google.com)
...
```text
🔭  Currently     Building scalable microservice APIs at TCS with .NET & Spring Boot
🌱  Learning      Cloud-native patterns, System Design & Advanced Kubernetes
👯  Open to       Collaborate on open-source .NET / React / ML projects
💬  Ask me about  REST API design, Microservices, React optimization, ML models
📫  Reach me      debojitpro1234@gmail.com
⚡  Fun fact      I've published 3 research papers AND ship production code daily
```
...
<sub>⭐ If you find my work helpful, consider starring the repos — it means a lot! ⭐</sub>
